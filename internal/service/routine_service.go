...
type RoutineService interface {
	...
	CreateRoutine(ctx context.Context, req *dto.CreateRoutineRequest) (*domain.Routine, error)
	ImportRoutine(ctx context.Context, req *dto.ImportRoutineRequest) (*domain.Routine, error)
...
func (s *routineService) CreateRoutine(ctx context.Context, req *dto.CreateRoutineRequest) (*domain.Routine, error) {
	// Deactivate existing routines for this user
	if err := s.routineRepo.DeactivateUserRoutines(ctx, req.UserID); err != nil {
		return nil, fmt.Errorf("error deactivating old routines: %w", err)
	}
...
func (s *routineService) ImportRoutine(ctx context.Context, req *dto.ImportRoutineRequest) (*domain.Routine, error) {
